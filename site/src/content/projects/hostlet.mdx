...
links:
  - label: View Hostlet repo
    href: https://github.com/KanterLabs/hostlet-core
  - label: View v0.1.0 release
    href: https://github.com/ShaneKanterman04/Hostlet/releases/tag/v0.1.0
system:
  caption: The Rust API signs deploy jobs for a local agent, which builds the GitHub project into a Docker container and updates the Caddy route only after a health check passes.
  tiers:
    - nodes:
        - title: GitHub repo
    - nodes:
